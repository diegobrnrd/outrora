...
STORY_STATES = [
    {
        "pergunta": (
            "Durante um acampamento com amigos, uma noite que era para ser tranquila se transforma "
    ...
    {
        "pergunta": (
            "Saindo da barraca de acampamento com uma lanterna em punho,\nseu objetivo é alcançar uma "
    ...
    {
        "pergunta": (
            "Sob o manto da noite, uma presença ameaçadora se materializa nos cantos mais profundos "
    ...
    {
        "pergunta": (
            "Ao acariciar o filhote de urso-pardo, um rugido ensurdecedor rompe a noite, indicando a "
    ...
    {
        "pergunta": (
            "Desesperado, você corre pela escuridão; a luz da sua lanterna é insuficiente para tal "
    ...
    {
        "pergunta": (
            "Conforme você avança pela floresta, vislumbrando a cabana ao longe, a sensação de "
    ...
    {
        "pergunta": (
            "Ao ficar a apenas três passos da porta da cabana, você é surpreendido por um barulho sutil "
            "vindo dos fundos."
        ),
    ...
    {
        "pergunta": (
            "Você tenta girar a maçaneta para abrir a porta da frente. No entanto, uma resistência "
    ...
    {
        "pergunta": (
            "Diante de seus olhos, surgem vislumbres de memórias há muito esquecidas: risos sob o luar, "
    ...
    {
        "pergunta": (
            "Nesse breve instante, o peso do desconhecido se dissipa temporariamente,\ne você se "
    ...
    {
        "pergunta": (
            "No entanto, como uma estrela cadente que se desvanece no firmamento, essa lucidez efêmera "
    ...
    {
        "pergunta": (
            "As memórias escorrem por seus dedos como areia, deixando apenas a sensação de algo "
            "inatingível."
        ),
        "escolhas": ["Continuar"],
    },
    {
        "pergunta": (
            "Um silêncio melancólico preenche o espaço, enquanto você mergulha novamente na névoa de "
